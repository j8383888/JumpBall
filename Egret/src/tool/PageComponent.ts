...
class PageComponent {
	...
	/*前翻按钮*/
	private _btnPre: Button = null;
	/*后翻按钮*/
	private _btnNext: Button = null;
	/*跳到最终页按钮*/
	private _btnFinally: Button = null;
	/*callback function*/
	 ...
	 */
	public constructor(btnPre: Button, btnNext: Button = null, tfPage: eui.Label = null, btnFinally: Button = null) {
		this._btnPre = btnPre;
